...
/usr/bin/mips64-linux-gnuabi64-as -EB -64 -march=mips64r2 -o /tmp/sc.o shellcode_64.s && /usr/bin/mips64-linux-gnuabi64-objcopy -j .shellcode -Obinary /tmp/sc.o /tmp/sc.bin && xxd -p /tmp/sc.bin | tr -d '\n' && echo
*/
