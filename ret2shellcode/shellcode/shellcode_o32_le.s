...
/usr/bin/mips-linux-gnu-as -EL -32 -march=mips32r2 -o /tmp/sc.o shellcode_o32_le.s && /usr/bin/mips-linux-gnu-objcopy -j .shellcode -Obinary /tmp/sc.o /tmp/sc.bin && xxd -p /tmp/sc.bin | tr -d '\n' && echo
*/
